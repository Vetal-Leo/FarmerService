...
{
    public class GrowingFieldProfits : BaseEntity, IEntity<int>
    {
        #region Properties
        [Key]
        [ForeignKey("GrowingFieldComings")]
        [Column("GrowingFieldId")]  
        ...
        public virtual GrowingFieldComings GrowingFieldComings { get; set; }
