...
namespace Farmer.Controllers
{
    ...
    public class AccountController : BaseApiController
    {
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            var user = new FarmerUser() { UserName = model.Email, Email = model.Email };
        ...
        private async Task SendActivationEmail(string email, string password)
        {
            var emailservice = new EmailService();
            var identy = new IdentityMessage { Destination = email };
            var callbackUrl = @Url.Content("/AccountSimple/Activation?id=0&email=" + email);
            identy.Subject = "Активация аккаунта.";
            identy.Body = "<h2>Сервис Farmer.</h2>Благодарим Вас за выбор сервиса \"Farmer\".<br/>" +
                          "<h3>Ваш Логин : " + email + "<br/>Ваш пароль : " + password +
                          "</h3>Для завершения регистрации и активации Вашего аккаунта перейдите по ссылке: " +
                          " <a href=\"" + callbackUrl + "\">Активировать аккаунт</a>";
        ...
        {
            return new[] { ApplicationUser.EmailConfirmed, ApplicationUser.АccountBlocking };
        }
    ...
    public class AccountSimpleController : Controller
    {
        ...
        // GET: /AccountSimple/Register
        public ActionResult Register()
        {
            // ReSharper disable once Mvc.ViewNotResolved
            return View();
        }
        // GET: /AccountSimple/Login
        ...
        {
            _usersservice.Activation(email);
            // ReSharper disable once Mvc.ViewNotResolved
            return View();
        }
    }
    ...
    public class EmailService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            const string @from = "farmer-origin@mail.ru";
            const string pass = "87pobeda78";

            // адрес и порт smtp-сервера, с которого отправляем письмо
            ...
            // письмо: message.Destination - адрес получателя
    ...
    public class FarmerAuthorize : AuthorizeAttribute
    {
        ...
        {
            // If the user is not authorized, he is redirected to AccountSimple/Login
            var auth = filterContext.HttpContext.User.Identity.IsAuthenticated;
            if (!auth)
            {
                filterContext.Result = new RedirectToRouteResult(
                    new RouteValueDictionary {
                { "controller", "AccountSimple" }, { "action", "Login" }
                });
            }
        }
    }
