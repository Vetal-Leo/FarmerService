...
namespace Servises.Breeding
{
    public partial class BreedingService
    {
        ...
        public List<YoungBreeding> GetPonyYoungs(int userId)
        {
            return Calculate(_youngBreedingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pony").ToList());
        }

        public void AddNewPonyYoung(int userId, FormCollection collection)
        {
            var youngcamel = new YoungBreeding
            {
                User = _usersRepository.Get().FirstOrDefault(i => i.Id == userId),
                BreedingType = _breedingTypeRepository.Get().FirstOrDefault(i => i.Name == "Pony"),
        ...
        public YoungBreeding GetPonyYoungById(int id)
        {
            ...
            return new YoungBreeding
            {
                ...
                BreedingCultureses = _breedingCulturesRepository.Get().Where(c => c.BreedingType.Name == "Pony")
            };
        }

        public async Task AddNewPonyYoungById(int id, FormCollection collection)
        {
            var picked = _youngBreedingRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public void DeletePonyYoungById(int id)
        {
        ...
        public List<BreedingComings> GetPonyComings(int userId)
        {
            return Calculate(_breedingComingsRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pony").ToList());
        }

        public async Task AddNewPonyComing(int userId, FormCollection collection)
        {
        ...
        public BreedingComings GetPonyComingById(int id)
        {
        ...
        public async Task AddNewPonyComingById(int id, FormCollection collection)
        {
            var picked = _breedingComingsRepository.Get().Where(i => i.Id == id).ToList()[0];
            picked.ReceiptDate = DateTime.Parse(collection[1]);
            picked.CultureType = collection[2];
        ...
        public void DeletePonyComingById(int id)
        {
        ...
        public List<BreedingCharges> GetPonyCharges(int userId)
        {
            return Calculate(_breedingChargesRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pony").ToList());
        }

        public List<string> GetPonyNamesById(int id)
        {
            var camels = _breedingComingsRepository.Get().Where(i => i.User.Id == id && i.BreedingType.Name == "Pony").ToList();
            return camels.Select(item => item.Name).ToList();
        }

        public async Task AddNewPonyCharges(int userId, FormCollection collection)
        {
        ...
        public BreedingCharges GetPonyChargesById(int id)
        {
        ...
        public async Task AddNewPonyChargesById(int id, FormCollection collection)
        {
        ...
        public void DeletePonyChargesById(int id)
        {
        ...
        public List<BreedingDailyProfit> GetPonyDailyProfits(int userId)
        {
            return Calculate(_breedingDailyProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pony").ToList(), userId);
        }

        public async Task AddNewPonyDailyProfits(int userId, FormCollection collection)
        {
        ...
        public BreedingDailyProfit GetPonyDailyProfitById(int id)
        {
        ...
        public async Task AddNewPonyDailyProfitById(int id, FormCollection collection)
        {
        ...
        public void DeletePonyDailyProfitById(int id)
        {
        ...
        public List<BreedingProfits> GetPonyProfits(int userId)
        {
            return Calculate(_breedingProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pony").ToList());
        }

        public BreedingProfits GetPonyProfitById(int id)
        {
        ...
        public async Task AddNewPonyProfitById(int id, FormCollection collection)
        {
            var picked = _breedingProfitRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public List<BreedingReminder> GetPonyRemindings(int userId)
        {
            return _breedingRemindingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pony").ToList();
        }

        public async Task AddNewPonyReminding(int userId, FormCollection collection)
        {
        ...
        public BreedingReminder GetPonyRemindingById(int id)
        {
        ...
        public async Task AddNewPonyRemindingById(int id, FormCollection collection)
        {
        ...
        public void DeletePonyRemindingById(int id)
        {
