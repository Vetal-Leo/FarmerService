...
namespace Servises.Breeding
{
    public partial class BreedingService
    {
        ...
        public List<BreedingComings> GetQuailComings(int userId)
        {
            return Calculate(_breedingComingsRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Quail").ToList());
        }
        ...
        public BreedingComings GetQuailComingById(int id)
        {
            ...
            return new BreedingComings
            {
                ...
                BreedingCultureses = _breedingCulturesRepository.Get().Where(c => c.BreedingType.Name == "Quail")
            };
        }

        public async Task AddNewQuailComingById(int id, FormCollection collection)
        {
            var picked = _breedingComingsRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public void DeleteQuailComingById(int id)
        {
        ...
        public List<BreedingCharges> GetQuailCharges(int userId)
        {
            return Calculate(_breedingChargesRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Quail").ToList());
        }

        public List<string> GetQuailNamesById(int id)
        {
            var camels = _breedingComingsRepository.Get().Where(i => i.User.Id == id && i.BreedingType.Name == "Quail").ToList();
        ...
        public BreedingCharges GetQuailChargesById(int id)
        {
        ...
        public async Task AddNewQuailChargesById(int id, FormCollection collection)
        {
        ...
        public void DeleteQuailChargesById(int id)
        {
        ...
        public List<BreedingDailyProfit> GetQuailDailyProfits(int userId)
        {
            return Calculate(_breedingDailyProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Quail").ToList(), userId);
        }

        public async Task AddNewQuailDailyProfits(int userId, FormCollection collection)
        {
        ...
        public BreedingDailyProfit GetQuailDailyProfitById(int id)
        {
        ...
        public async Task AddNewQuailDailyProfitById(int id, FormCollection collection)
        {
        ...
        public void DeleteQuailDailyProfitById(int id)
        {
        ...
        public List<BreedingProfits> GetQuailProfits(int userId)
        {
            return Calculate(_breedingProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Quail").ToList());
        }

        public BreedingProfits GetQuailProfitById(int id)
        {
        ...
        public async Task AddNewQuailProfitById(int id, FormCollection collection)
        {
            var picked = _breedingProfitRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        #region QuailRemiding

        public List<BreedingReminder> GetQuailRemindings(int userId)
        {
            return _breedingRemindingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Quail").ToList();
        }

        public async Task AddNewQuailReminding(int userId, FormCollection collection)
        {
        ...
        public BreedingReminder GetQuailRemindingById(int id)
        {
        ...
        public async Task AddNewQuailRemindingById(int id, FormCollection collection)
        {
        ...
        public void DeleteQuailRemindingById(int id)
        {
