...
namespace Servises.Breeding
{
    public partial class BreedingService
    {
        ...
        public List<BreedingComings> GetBorzoidogComings(int userId)
        {
            return Calculate(_breedingComingsRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Borzoidog").ToList());
        }

        public async Task AddNewBorzoidogComing(int userId, FormCollection collection)
        {
            var camel = new BreedingComings
            {
                User = _usersRepository.Get().FirstOrDefault(i => i.Id == userId),
                BreedingType = _breedingTypeRepository.Get().FirstOrDefault(i => i.Name == "Borzoidog"),
        ...
        public BreedingComings GetBorzoidogComingById(int id)
        {
            ...
            return new BreedingComings
            {
                ...
                BreedingCultureses = _breedingCulturesRepository.Get().Where(c => c.BreedingType.Name == "Borzoidog")
            };
        }

        public async Task AddNewBorzoidogComingById(int id, FormCollection collection)
        {
            var picked = _breedingComingsRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public void DeleteBorzoidogComingById(int id)
        {
        ...
        public List<BreedingCharges> GetBorzoidogCharges(int userId)
        {
            return Calculate(_breedingChargesRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Borzoidog").ToList());
        }

        public List<string> GetBorzoidogNamesById(int id)
        {
            var camels = _breedingComingsRepository.Get().Where(i => i.User.Id == id && i.BreedingType.Name == "Borzoidog").ToList();
            return camels.Select(item => item.Name).ToList();
        }

        public async Task AddNewBorzoidogCharges(int userId, FormCollection collection)
        {
        ...
        public BreedingCharges GetBorzoidogChargesById(int id)
        {
        ...
        public async Task AddNewBorzoidogChargesById(int id, FormCollection collection)
        {
        ...
        public void DeleteBorzoidogChargesById(int id)
        {
        ...
        #region BorzoidogProfit

        public List<BreedingProfits> GetBorzoidogProfits(int userId)
        {
            return Calculate(_breedingProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Borzoidog").ToList());
        }

        public BreedingProfits GetBorzoidogProfitById(int id)
        {
        ...
        public async Task AddNewBorzoidogProfitById(int id, FormCollection collection)
        {
            var picked = _breedingProfitRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        #region BorzoidogRemiding

        public List<BreedingReminder> GetBorzoidogRemindings(int userId)
        {
            return _breedingRemindingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Borzoidog").ToList();
        }

        public async Task AddNewBorzoidogReminding(int userId, FormCollection collection)
        {
        ...
        public BreedingReminder GetBorzoidogRemindingById(int id)
        {
        ...
        public async Task AddNewBorzoidogRemindingById(int id, FormCollection collection)
        {
        ...
        public void DeleteBorzoidogRemindingById(int id)
        {
