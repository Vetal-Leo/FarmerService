...
namespace Servises.Breeding
{
    public partial class BreedingService
    {
        ...
        public List<YoungBreeding> GetSwineYoungs(int userId)
        {
            return Calculate(_youngBreedingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Swine").ToList());
        }

        public void AddNewSwineYoung(int userId, FormCollection collection)
        {
            var youngcamel = new YoungBreeding
            {
                User = _usersRepository.Get().FirstOrDefault(i => i.Id == userId),
                BreedingType = _breedingTypeRepository.Get().FirstOrDefault(i => i.Name == "Swine"),
        ...
        public YoungBreeding GetSwineYoungById(int id)
        {
            ...
            return new YoungBreeding
            {
                ...
                BreedingCultureses = _breedingCulturesRepository.Get().Where(c => c.BreedingType.Name == "Swine")
            };
        }

        public async Task AddNewSwineYoungById(int id, FormCollection collection)
        {
            var picked = _youngBreedingRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public void DeleteSwineYoungById(int id)
        {
        ...
        public List<BreedingComings> GetSwineComings(int userId)
        {
            return Calculate(_breedingComingsRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Swine").ToList());
        }

        public async Task AddNewSwineComing(int userId, FormCollection collection)
        {
        ...
        public BreedingComings GetSwineComingById(int id)
        {
        ...
        public async Task AddNewSwineComingById(int id, FormCollection collection)
        {
            var picked = _breedingComingsRepository.Get().Where(i => i.Id == id).ToList()[0];
            picked.ReceiptDate = DateTime.Parse(collection[1]);
            picked.CultureType = collection[2];
        ...
        public void DeleteSwineComingById(int id)
        {
        ...
        public List<BreedingCharges> GetSwineCharges(int userId)
        {
            return Calculate(_breedingChargesRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Swine").ToList());
        }

        public List<string> GetSwineNamesById(int id)
        {
            var camels = _breedingComingsRepository.Get().Where(i => i.User.Id == id && i.BreedingType.Name == "Swine").ToList();
            return camels.Select(item => item.Name).ToList();
        }

        public async Task AddNewSwineCharges(int userId, FormCollection collection)
        {
        ...
        public BreedingCharges GetSwineChargesById(int id)
        {
        ...
        public async Task AddNewSwineChargesById(int id, FormCollection collection)
        {
        ...
        public List<BreedingProfits> GetSwineProfits(int userId)
        {
            return Calculate(_breedingProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Swine").ToList());
        }

        public BreedingProfits GetSwineProfitById(int id)
        {
        ...
        public async Task AddNewSwineProfitById(int id, FormCollection collection)
        {
            var picked = _breedingProfitRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        #region SwineRemiding

        public List<BreedingReminder> GetSwineRemindings(int userId)
        {
            return _breedingRemindingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Swine").ToList();
        }

        public async Task AddNewSwineReminding(int userId, FormCollection collection)
        {
        ...
        public BreedingReminder GetSwineRemindingById(int id)
        {
        ...
        public async Task AddNewSwineRemindingById(int id, FormCollection collection)
        {
        ...
        public void DeleteSwineRemindingById(int id)
        {
