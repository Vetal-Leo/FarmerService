...
namespace Servises.Breeding
{
    public partial class BreedingService
    {
        ...
        public List<BreedingComings> GetPinscherdogComings(int userId)
        {
            return Calculate(_breedingComingsRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pinscherdog").ToList());
        }
        ...
        public BreedingComings GetPinscherdogComingById(int id)
        {
            ...
            return new BreedingComings
            {
                ...
                BreedingCultureses = _breedingCulturesRepository.Get().Where(c => c.BreedingType.Name == "Pinscherdog")
            };
        }

        public async Task AddNewPinscherdogComingById(int id, FormCollection collection)
        {
            var picked = _breedingComingsRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public void DeletePinscherdogComingById(int id)
        {
        ...
        public List<BreedingCharges> GetPinscherdogCharges(int userId)
        {
            return Calculate(_breedingChargesRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pinscherdog").ToList());
        }

        public List<string> GetPinscherdogNamesById(int id)
        {
            var camels = _breedingComingsRepository.Get().Where(i => i.User.Id == id && i.BreedingType.Name == "Pinscherdog").ToList();
        ...
        public BreedingCharges GetPinscherdogChargesById(int id)
        {
        ...
        public async Task AddNewPinscherdogChargesById(int id, FormCollection collection)
        {
        ...
        public void DeletePinscherdogChargesById(int id)
        {
        ...
        public List<BreedingProfits> GetPinscherdogProfits(int userId)
        {
            return Calculate(_breedingProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pinscherdog").ToList());
        }

        public BreedingProfits GetPinscherdogProfitById(int id)
        {
        ...
        public async Task AddNewPinscherdogProfitById(int id, FormCollection collection)
        {
            var picked = _breedingProfitRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        #region PinscherdogRemiding

        public List<BreedingReminder> GetPinscherdogRemindings(int userId)
        {
            return _breedingRemindingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Pinscherdog").ToList();
        }

        public async Task AddNewPinscherdogReminding(int userId, FormCollection collection)
        {
        ...
        public BreedingReminder GetPinscherdogRemindingById(int id)
        {
        ...
        public async Task AddNewPinscherdogRemindingById(int id, FormCollection collection)
        {
        ...
        public void DeletePinscherdogRemindingById(int id)
        {
