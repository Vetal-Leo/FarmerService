...
namespace Servises.Breeding
{
    public partial class BreedingService
    {
        ...
        public List<YoungBreeding> GetCattlemixedYoungs(int userId)
        {
            return Calculate(_youngBreedingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemixed").ToList());
        }

        public void AddNewCattlemixedYoung(int userId, FormCollection collection)
        {
            var youngcamel = new YoungBreeding
            {
                User = _usersRepository.Get().FirstOrDefault(i => i.Id == userId),
                BreedingType = _breedingTypeRepository.Get().FirstOrDefault(i => i.Name == "Cattlemixed"),
        ...
        public YoungBreeding GetCattlemixedYoungById(int id)
        {
            ...
            return new YoungBreeding
            {
                ...
                BreedingCultureses = _breedingCulturesRepository.Get().Where(c => c.BreedingType.Name == "Cattlemixed")
            };
        }

        public async Task AddNewCattlemixedYoungById(int id, FormCollection collection)
        {
            var picked = _youngBreedingRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public void DeleteCattlemixedYoungById(int id)
        {
        ...
        public List<BreedingComings> GetCattlemixedComings(int userId)
        {
            return Calculate(_breedingComingsRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemixed").ToList());
        }

        public async Task AddNewCattlemixedComing(int userId, FormCollection collection)
        {
        ...
        public BreedingComings GetCattlemixedComingById(int id)
        {
        ...
        public async Task AddNewCattlemixedComingById(int id, FormCollection collection)
        {
            var picked = _breedingComingsRepository.Get().Where(i => i.Id == id).ToList()[0];
            picked.ReceiptDate = DateTime.Parse(collection[1]);
            picked.CultureType = collection[2];
        ...
        public void DeleteCattlemixedComingById(int id)
        {
        ...
        public List<BreedingCharges> GetCattlemixedCharges(int userId)
        {
            return Calculate(_breedingChargesRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemixed").ToList());
        }

        public List<string> GetCattlemixedNamesById(int id)
        {
            var camels = _breedingComingsRepository.Get().Where(i => i.User.Id == id && i.BreedingType.Name == "Cattlemixed").ToList();
            return camels.Select(item => item.Name).ToList();
        }

        public async Task AddNewCattlemixedCharges(int userId, FormCollection collection)
        {
        ...
        public BreedingCharges GetCattlemixedChargesById(int id)
        {
        ...
        public async Task AddNewCattlemixedChargesById(int id, FormCollection collection)
        {
        ...
        public void DeleteCattlemixedChargesById(int id)
        {
        ...
        public List<BreedingDailyProfit> GetCattlemixedDailyProfits(int userId)
        {
            return Calculate(_breedingDailyProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemixed").ToList(), userId);
        }

        public async Task AddNewCattlemixedDailyProfits(int userId, FormCollection collection)
        {
        ...
        public BreedingDailyProfit GetCattlemixedDailyProfitById(int id)
        {
        ...
        public async Task AddNewCattlemixedDailyProfitById(int id, FormCollection collection)
        {
        ...
        public void DeleteCattlemixedDailyProfitById(int id)
        {
        ...
        #region CattlemixedProfit

        public List<BreedingProfits> GetCattlemixedProfits(int userId)
        {
            return Calculate(_breedingProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemixed").ToList());
        }

        public BreedingProfits GetCattlemixedProfitById(int id)
        {
        ...
        public async Task AddNewCattlemixedProfitById(int id, FormCollection collection)
        {
            var picked = _breedingProfitRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        #region CattlemixedRemiding

        public List<BreedingReminder> GetCattlemixedRemindings(int userId)
        {
            return _breedingRemindingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemixed").ToList();
        }

        public async Task AddNewCattlemixedReminding(int userId, FormCollection collection)
        {
        ...
        public BreedingReminder GetCattlemixedRemindingById(int id)
        {
        ...
        public async Task AddNewCattlemixedRemindingById(int id, FormCollection collection)
        {
        ...
        public void DeleteCattlemixedRemindingById(int id)
        {
