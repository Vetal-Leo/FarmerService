...
namespace Servises.Breeding
{
    public partial class BreedingService
    {
        ...
        public List<YoungBreeding> GetCattlemeatYoungs(int userId)
        {
            return Calculate(_youngBreedingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemeat").ToList());
        }

        public void AddNewCattlemeatYoung(int userId, FormCollection collection)
        {
            var youngcamel = new YoungBreeding
            {
                User = _usersRepository.Get().FirstOrDefault(i => i.Id == userId),
                BreedingType = _breedingTypeRepository.Get().FirstOrDefault(i => i.Name == "Cattlemeat"),
        ...
        public YoungBreeding GetCattlemeatYoungById(int id)
        {
            ...
            return new YoungBreeding
            {
                ...
                BreedingCultureses = _breedingCulturesRepository.Get().Where(c => c.BreedingType.Name == "Cattlemeat")
            };
        }

        public async Task AddNewCattlemeatYoungById(int id, FormCollection collection)
        {
            var picked = _youngBreedingRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public void DeleteCattlemeatYoungById(int id)
        {
        ...
        public List<BreedingComings> GetCattlemeatComings(int userId)
        {
            return Calculate(_breedingComingsRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemeat").ToList());
        }

        public async Task AddNewCattlemeatComing(int userId, FormCollection collection)
        {
        ...
        public BreedingComings GetCattlemeatComingById(int id)
        {
        ...
        public async Task AddNewCattlemeatComingById(int id, FormCollection collection)
        {
            var picked = _breedingComingsRepository.Get().Where(i => i.Id == id).ToList()[0];
            picked.ReceiptDate = DateTime.Parse(collection[1]);
            picked.CultureType = collection[2];
        ...
        public void DeleteCattlemeatComingById(int id)
        {
        ...
        public List<BreedingCharges> GetCattlemeatCharges(int userId)
        {
            return Calculate(_breedingChargesRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemeat").ToList());
        }

        public List<string> GetCattlemeatNamesById(int id)
        {
            var camels = _breedingComingsRepository.Get().Where(i => i.User.Id == id && i.BreedingType.Name == "Cattlemeat").ToList();
            return camels.Select(item => item.Name).ToList();
        }

        public async Task AddNewCattlemeatCharges(int userId, FormCollection collection)
        {
        ...
        public BreedingCharges GetCattlemeatChargesById(int id)
        {
        ...
        public async Task AddNewCattlemeatChargesById(int id, FormCollection collection)
        {
        ...
        public void DeleteCattlemeatChargesById(int id)
        {
        ...
        public List<BreedingDailyProfit> GetCattlemeatDailyProfits(int userId)
        {
            return Calculate(_breedingDailyProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemeat").ToList(), userId);
        }

        public async Task AddNewCattlemeatDailyProfits(int userId, FormCollection collection)
        {
        ...
        public BreedingDailyProfit GetCattlemeatDailyProfitById(int id)
        {
        ...
        public async Task AddNewCattlemeatDailyProfitById(int id, FormCollection collection)
        {
        ...
        public void DeleteCattlemeatDailyProfitById(int id)
        {
        ...
        #region CattlemeatProfit

        public List<BreedingProfits> GetCattlemeatProfits(int userId)
        {
            return Calculate(_breedingProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemeat").ToList());
        }

        public BreedingProfits GetCattlemeatProfitById(int id)
        {
        ...
        public async Task AddNewCattlemeatProfitById(int id, FormCollection collection)
        {
            var picked = _breedingProfitRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        #region CattlemeatRemiding

        public List<BreedingReminder> GetCattlemeatRemindings(int userId)
        {
            return _breedingRemindingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Cattlemeat").ToList();
        }

        public async Task AddNewCattlemeatReminding(int userId, FormCollection collection)
        {
        ...
        public BreedingReminder GetCattlemeatRemindingById(int id)
        {
        ...
        public async Task AddNewCattlemeatRemindingById(int id, FormCollection collection)
        {
        ...
        public void DeleteCattlemeatRemindingById(int id)
        {
