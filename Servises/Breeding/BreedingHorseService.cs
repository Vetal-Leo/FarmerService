...
namespace Servises.Breeding
{
    public partial class BreedingService
    {
        ...
        public List<YoungBreeding> GetHorseYoungs(int userId)
        {
            return Calculate(_youngBreedingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Horse").ToList());
        }

        public void AddNewHorseYoung(int userId, FormCollection collection)
        {
            var youngcamel = new YoungBreeding
            {
                User = _usersRepository.Get().FirstOrDefault(i => i.Id == userId),
                BreedingType = _breedingTypeRepository.Get().FirstOrDefault(i => i.Name == "Horse"),
        ...
        public YoungBreeding GetHorseYoungById(int id)
        {
            ...
            return new YoungBreeding
            {
                ...
                BreedingCultureses = _breedingCulturesRepository.Get().Where(c => c.BreedingType.Name == "Horse")
            };
        }

        public async Task AddNewHorseYoungById(int id, FormCollection collection)
        {
            var picked = _youngBreedingRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public void DeleteHorseYoungById(int id)
        {
        ...
        public List<BreedingComings> GetHorseComings(int userId)
        {
            return Calculate(_breedingComingsRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Horse").ToList());
        }

        public async Task AddNewHorseComing(int userId, FormCollection collection)
        {
        ...
        public BreedingComings GetHorseComingById(int id)
        {
        ...
        public async Task AddNewHorseComingById(int id, FormCollection collection)
        {
            var picked = _breedingComingsRepository.Get().Where(i => i.Id == id).ToList()[0];
            picked.ReceiptDate = DateTime.Parse(collection[1]);
            picked.CultureType = collection[2];
        ...
        public void DeleteHorseComingById(int id)
        {
        ...
        public List<BreedingCharges> GetHorseCharges(int userId)
        {
            return Calculate(_breedingChargesRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Horse").ToList());
        }

        public List<string> GetHorseNamesById(int id)
        {
            var camels = _breedingComingsRepository.Get().Where(i => i.User.Id == id && i.BreedingType.Name == "Horse").ToList();
            return camels.Select(item => item.Name).ToList();
        }

        public async Task AddNewHorseCharges(int userId, FormCollection collection)
        {
        ...
        public BreedingCharges GetHorseChargesById(int id)
        {
        ...
        public async Task AddNewHorseChargesById(int id, FormCollection collection)
        {
        ...
        public void DeleteHorseChargesById(int id)
        {
        ...
        public List<BreedingDailyProfit> GetHorseDailyProfits(int userId)
        {
            return Calculate(_breedingDailyProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Horse").ToList(), userId);
        }

        public async Task AddNewHorseDailyProfits(int userId, FormCollection collection)
        {
        ...
        public BreedingDailyProfit GetHorseDailyProfitById(int id)
        {
        ...
        public async Task AddNewHorseDailyProfitById(int id, FormCollection collection)
        {
        ...
        public void DeleteHorseDailyProfitById(int id)
        {
        ...
        public List<BreedingProfits> GetHorseProfits(int userId)
        {
            return Calculate(_breedingProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Horse").ToList());
        }

        public BreedingProfits GetHorseProfitById(int id)
        {
        ...
        public async Task AddNewHorseProfitById(int id, FormCollection collection)
        {
            var picked = _breedingProfitRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        #region HorseRemiding

        public List<BreedingReminder> GetHorseRemindings(int userId)
        {
            return _breedingRemindingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "Horse").ToList();
        }

        public async Task AddNewHorseReminding(int userId, FormCollection collection)
        {
        ...
        public BreedingReminder GetHorseRemindingById(int id)
        {
        ...
        public async Task AddNewHorseRemindingById(int id, FormCollection collection)
        {
        ...
        public void DeleteHorseRemindingById(int id)
        {
