...
namespace Servises.Breeding
{
    public partial class BreedingService
    {
        ...
        public List<BreedingComings> GetHenMeatComings(int userId)
        {
            return Calculate(_breedingComingsRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "HenMeat").ToList());
        }

        public async Task AddNewHenMeatComing(int userId, FormCollection collection)
        {
            var camel = new BreedingComings
            {
                User = _usersRepository.Get().FirstOrDefault(i => i.Id == userId),
                BreedingType = _breedingTypeRepository.Get().FirstOrDefault(i => i.Name == "HenMeat"),
        ...
        public BreedingComings GetHenMeatComingById(int id)
        {
            ...
            return new BreedingComings
            {
                ...
                BreedingCultureses = _breedingCulturesRepository.Get().Where(c => c.BreedingType.Name == "HenMeat")
            };
        }

        public async Task AddNewHenMeatComingById(int id, FormCollection collection)
        {
            var picked = _breedingComingsRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        public void DeleteHenMeatComingById(int id)
        {
        ...
        public List<BreedingCharges> GetHenMeatCharges(int userId)
        {
            return Calculate(_breedingChargesRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "HenMeat").ToList());
        }

        public List<string> GetHenMeatNamesById(int id)
        {
            var camels = _breedingComingsRepository.Get().Where(i => i.User.Id == id && i.BreedingType.Name == "HenMeat").ToList();
            return camels.Select(item => item.Name).ToList();
        }

        public async Task AddNewHenMeatCharges(int userId, FormCollection collection)
        {
        ...
        public BreedingCharges GetHenMeatChargesById(int id)
        {
        ...
        public async Task AddNewHenMeatChargesById(int id, FormCollection collection)
        {
        ...
        public void DeleteHenMeatChargesById(int id)
        {
        ...
        public List<BreedingDailyProfit> GetHenMeatDailyProfits(int userId)
        {
            return Calculate(_breedingDailyProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "HenMeat").ToList(), userId);
        }

        public async Task AddNewHenMeatDailyProfits(int userId, FormCollection collection)
        {
        ...
        public BreedingDailyProfit GetHenMeatDailyProfitById(int id)
        {
        ...
        public async Task AddNewHenMeatDailyProfitById(int id, FormCollection collection)
        {
        ...
        public void DeleteHenMeatDailyProfitById(int id)
        {
        ...
        public List<BreedingProfits> GetHenMeatProfits(int userId)
        {
            return Calculate(_breedingProfitRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "HenMeat").ToList());
        }

        public BreedingProfits GetHenMeatProfitById(int id)
        {
        ...
        public async Task AddNewHenMeatProfitById(int id, FormCollection collection)
        {
            var picked = _breedingProfitRepository.Get().Where(i => i.Id == id).ToList()[0];
        ...
        #region HenMeatRemiding

        public List<BreedingReminder> GetHenMeatRemindings(int userId)
        {
            return _breedingRemindingRepository.Get().Where(i => i.User.Id == userId && i.BreedingType.Name == "HenMeat").ToList();
        }

        public async Task AddNewHenMeatReminding(int userId, FormCollection collection)
        {
        ...
        public BreedingReminder GetHenMeatRemindingById(int id)
        {
        ...
        public async Task AddNewHenMeatRemindingById(int id, FormCollection collection)
        {
        ...
        public void DeleteHenMeatRemindingById(int id)
        {
